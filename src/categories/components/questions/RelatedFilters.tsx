...
const RelatedFilters = ({ relatedFilters }: IProps) => {
    ...
    return (
        <div className='mx-0 my-1 border rounded-2 px-1 py-1 border-light fs-6 related-filters'>
            <div>
                <label className="text-muted related-filters" title="For the next Question in ChatBot">Most frequently selected Filters</label>
